...
namespace Components\PHPSandbox\Entrypoints\Clients;
...
class Client implements EntrypointClientInterface
{
    ...
    {
        $username = config('phpsandbox.ws_entrypoint.basic_auth_username');
        $password = config('phpsandbox.ws_entrypoint.basic_auth_password');
